  ...
  return (
    <div className="accountancy-container">
         ...
         <div className="item2">
            ...
            <p>In my second year at Walter Sisulu University in 2016 I ventured into entrepreneurship which was already apparent in my talents and skill set. This was powered mainly by the gap I notice in how the current generation is intellectually wired versus how the current education system seeks to connect with the intellectual realm of human beings in schools.</p>

            <p>This saw me and my other co-founders registering a company called edgene, in full educated generation. The promise behind the company name is that we can now have an education system that can seamlessly connect human talents to real-life world problems.</p>
         </div>

  ...
  return (
    <div className="accountancy-container">
         ...
         <div className="item2">
            ...
            <p>As soon as I left Mthatha, where I was doing my training in an accounting firm to polish my accounting, taxation, and finance skills, I came to Cape Town with the hopes of getting a job with my experience in accounting.</p> 
            
            <p>At this point, I was already busy planning to develop an application or at least a prototype to my application. I had no programming experience at the time but I was hoping to leverage the app development personnel with my business friends who have programming background. Cape Town welcomed me with a course in Full Stack Software Development, a program funded by ABSA and implemented via UVU Africa, CapaCiti, Younglings. </p>

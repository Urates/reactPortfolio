...
const MobileBlog = () => {
    ...
    <div className='MobileBlog-Container'>
        ...
        <div className='DropDownHandler'>
            <span><a>Video Content</a><img src={ExpandIcon} alt='expand icon'/></span>
            <span><a>Image Content</a><img src={DropDownIcon} alt=' icon'/></span>
            <span><a>Reports Content</a><img src={DropDownIcon} alt='expand icon'/></span>
        </div>
    </div>
  );
}

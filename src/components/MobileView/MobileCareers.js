...
const MobileCareers = () => {
    ...
    <div className='MobileCareers-container'>
        ...
        <div>
            <a href=''><img src={AccountancySlide} alt='Accountancy slide'/></a>
            <p>Accountancy</p>
        </div>

        
        <div>
            <a href=''><img src={EntrepSlide} alt='Entrepreneurship slide'/></a>
            <p>Entrepreneurship</p>
        </div>

        <div>
            <a href=''><img src={SoftwareDevSlide} alt='Software development slide'/></a>
